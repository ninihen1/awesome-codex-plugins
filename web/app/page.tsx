...
const plugins = [
  ...
  { name: "Project Autopilot", desc: "Turn an idea into a structured project workflow with planning, execution, and handoff", author: "AlexMi64", authorUrl: "https://github.com/AlexMi64", url: "https://github.com/AlexMi64/codex-project-autopilot", category: "Development & Workflow", official: false },
  ...
  { name: "HOTL Plugin", desc: "Human-on-the-Loop AI coding workflows with planning, review, and verification", author: "yimwoo", authorUrl: "https://github.com/yimwoo", url: "https://github.com/yimwoo/hotl-plugin", category: "Development & Workflow", official: false },
  { name: "AgentOps", desc: "DevOps layer for coding agents with flow, feedback, and memory that compounds between sessions", author: "boshu2", authorUrl: "https://github.com/boshu2", url: "https://github.com/boshu2/agentops", category: "Development & Workflow", official: false },
  ...
  { name: "PapersFlow", desc: "Paper discovery, citation verification, graph exploration, and DeepScan analysis", author: "papersflow-ai", authorUrl: "https://github.com/papersflow-ai", url: "https://github.com/papersflow-ai/papersflow-codex-plugin", category: "Tools & Integrations", official: false },
  { name: "Apple Productivity", desc: "Local Apple Calendar and Reminders tooling for macOS with Codex plugin adapters", author: "matk0shub", authorUrl: "https://github.com/matk0shub", url: "https://github.com/matk0shub/apple-productivity-mcp", category: "Tools & Integrations", official: false },
  { name: "Yandex Direct", desc: "Codex plugin bundle for Yandex Direct, Wordstat, Metrika, and Roistat", author: "nebelov", authorUrl: "https://github.com/nebelov", url: "https://github.com/nebelov/yandex-direct-for-all", category: "Tools & Integrations", official: false },
  ...
  { name: "Codex Mem", desc: "Automatically capture, compress, and inject session context back into future sessions", author: "2kDarki", authorUrl: "https://github.com/2kDarki", url: "https://github.com/2kDarki/codex-mem", category: "Tools & Integrations", official: false },
];
...
export default function Home() {
  ...
  const showOfficial = query ? filteredOfficial.length > 0 : true;
  const showCommunity = query ? filteredCommunity.length > 0 : true;
  const hasResults = showOfficial || showCommunity;

  return (
    <div className="container">
      <div className="hero">
        <div className="hero-content">
          <h1>Awesome Codex Plugins</h1>
          <p>A curated directory of OpenAI Codex plugins. All community plugins verified with a valid .codex-plugin manifest.</p>
      ...
      {showCommunity && (
        <div className="section">
          ...
          {communityCategories.map((cat) => {
            const catPlugins = (query ? filteredCommunity : communityPlugins).filter(
              (p) => (p.category || "Community") === cat
            );
      ...
      <footer className="footer">
        <p>
          Maintained by{" "}
          <a href="https://github.com/internet-dot" target="_blank" rel="noopener noreferrer">
            internet-dot
          </a>
        </p>
        <div className="footer-links">
          <a href="https://github.com/internet-dot/awesome-codex-plugins" target="_blank" rel="noopener noreferrer">
            GitHub
          </a>
          <a href="https://github.com/internet-dot/awesome-codex-plugins/blob/main/CONTRIBUTING.md" target="_blank" rel="noopener noreferrer">
            Contributing
          </a>
